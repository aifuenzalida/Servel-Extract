rawdata = open("A1321001table.txt")
OutputFile = open("A1321001final.txt", 'w')
users = []
...
for line in rawdata:
    if len(line) >= 40:
        ...
        guion = "-"
        dist1 = "EL CENTRO"
        dist2 = "PARQUE ALMAGRO"
        dist3 = "PARQUE O'HIGGINS"
        ...
        if posdiscriminador == -1:
            ...
            posdist1 = line.find(dist1, largolinea - 30)
            posdist2 = line.find(dist2, largolinea - 30)
            posdist3 = line.find(dist3, largolinea - 30)
            varesp = " "
