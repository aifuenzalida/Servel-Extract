rawdata = open("A1321013table.txt")
OutputFile = open("A1321013final.txt", 'w')
users = []
...
for line in rawdata:
    if len(line) >= 40:
        ...
        if posdiscriminador == -1:
            ...
            posdist2 = line.find(dist2, largolinea - 25)
            posdist3 = line.find(dist3, largolinea - 25)
            varesp = " "
