rawdata = open("A1321025table.txt")
OutputFile = open("A1321025final.txt", 'w')
users = []
...
for line in rawdata:
    if len(line) >= 40:
        ...
        if posdiscriminador == -1:
            ...
            posdist1 = line.find(dist1, largolinea - 35)
            posdist2 = line.find(dist2, largolinea - 35)
            posdist3 = line.find(dist3, largolinea - 35)
            varesp = " "
